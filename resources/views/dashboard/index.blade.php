            ...
            <article class="article-container">
                ...
                <div class="text-right">
                    ...
                    @if (Auth::user()->role == 'admin')
                        <a href="#import" role="button" class="btn btn-outline-primary"
                            data-bs-toggle="modal">import/Export</a>
                    @endif
                    @if (Auth::user()->role == 'user')
                        <a href="#sendmail" role="button" class="btn btn-outline-primary" data-bs-toggle="modal">Add
                            suggession</a>
                    @endif
                </div>
                ...
                <section class="container mt-4 mb-5">
                    <div class="mx-auto shadow-default border-radius-lg" style="border: 1px solid #e6e7eb">
                        <div class="row" style="margin: 0 !important">
                            <div class="col-md-8">
                                <textarea id="spam-check-main-textarea" rows="18" onkeyup="countword()" onpaste="countword()"
                                    class="spam-text-area"></textarea>
                            </div>
                            ...
                            <div class="container box">
                                ...
                                <form method="post" action="{{ url('sendemail/send') }}">
                                    ...
                                    <div class="form-group ">
                                        <input type="submit" name="send" class="btn btn-outline-info"
                                            value="Send" />
                    ...
                    $('#spam-check-main-textarea').on('keyup', function() {
                        ...
                        found.map((item, index) => {
                            if (unique.filter(m => m.category === item.category).length > 0) {
                                unique.filter(m => m.category === item.category)[0].count = found.filter(
                                    f => f.category === item.category).length;
                            } else {
                                unique.push({
